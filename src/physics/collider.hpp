...
class Collider{
    public:
        ...
        float rotation; //also doesn't work :V (I have no time to implement it in this life, so lmao)
    protected:
    ...
    public:
        ...
        bool detectCollisionWith(Collider *other); //Returns true if collider is touching or is inside other collider.
};